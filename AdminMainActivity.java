...
public class AdminMainActivity extends AppCompatActivity {
    private Button viewBtn, goBackBtn;
    private ListView list_view;
    private String[] array;
    private FirebaseFirestore db;
    private ArrayList<NewUserClass> arrayList;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewBtn = (Button) findViewById(R.id.show_button1);
                ...
                myRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot SubSnapshot : snapshot.getChildren()) {
                            ...
                            ShowDataString = "User Name : " + userClass.getFirstName() + " " + userClass.getLastName() +
                                    "\nPhone Num : " + userClass.getPhoneNum() +
                                    "\nEmail Id : " + userClass.getEmailId();
                            if (str.length() == 0)
